...
-- 2. 상품 옵션 종류 → 옵션 값
-- 종류의 display_order = SKU 표시명 순서 (컬러 → 사이즈 = 블랙/270mm)
INSERT INTO product_option_type (product_id, name, display_order)
VALUES
    (1, '컬러', 1),      -- id 1
    (1, '사이즈', 2),    -- id 2
    (2, '컬러', 1),      -- id 3
...
-- 나이키 에어맥스 270 (option_type 1=컬러, 2=사이즈)
INSERT INTO product_option (option_type_id, option_value, display_order)
VALUES
    (1, '블랙', 1),      -- id 1
    (1, '화이트', 2),    -- id 2
    (2, '260mm', 1),     -- id 3
...
-- 아디다스 울트라부스트 22 (option_type 3=컬러, 4=사이즈)
INSERT INTO product_option (option_type_id, option_value, display_order)
VALUES
    (3, '블랙', 1),      -- id 6
    (3, '그레이', 2),    -- id 7
...
-- 3. SKU (product_item)
-- 나이키 에어맥스 270 SKU (표시명 블랙/260mm 등은 product_item_option 에서 만든다)
INSERT INTO product_item (product_id, barcode, sku_code, unit_price, cost_price, status, created_user_id)
VALUES
    (1, '8801234001', 'AM270-BK26', 129000.00, 65000.00, 1, 'SYSTEM'),
    (1, '8801234002', 'AM270-BK27', 129000.00, 65000.00, 1, 'SYSTEM'),
    (1, '8801234003', 'AM270-BK28', 129000.00, 65000.00, 1, 'SYSTEM'),
    (1, '8801234004', 'AM270-WH26', 129000.00, 65000.00, 1, 'SYSTEM'),
    (1, '8801234005', 'AM270-WH27', 129000.00, 65000.00, 1, 'SYSTEM'),
    (1, '8801234006', 'AM270-WH28', 129000.00, 65000.00, 1, 'SYSTEM');

-- 아디다스 울트라부스트 22 SKU
INSERT INTO product_item (product_id, barcode, sku_code, unit_price, cost_price, status, created_user_id)
VALUES
    (2, '8802345001', 'UB22-BK265', 189000.00, 95000.00, 1, 'SYSTEM'),
    (2, '8802345002', 'UB22-BK275', 189000.00, 95000.00, 1, 'SYSTEM'),
    (2, '8802345003', 'UB22-GR265', 189000.00, 95000.00, 1, 'SYSTEM'),
    (2, '8802345004', 'UB22-GR275', 189000.00, 95000.00, 1, 'SYSTEM');

-- 나이키 양말 세트 SKU (단일)
INSERT INTO product_item (product_id, barcode, sku_code, unit_price, cost_price, status, created_user_id)
VALUES
    (3, '8801234100', 'NK-SOCK-01', 15000.00, 5000.00, 1, 'SYSTEM');
